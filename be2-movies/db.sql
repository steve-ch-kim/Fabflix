...
CREATE TABLE movies.movie (
    ...
    FOREIGN KEY (director_id) REFERENCES movies.person (id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE movies.movie_genre (
    ...
    FOREIGN KEY (movie_id) REFERENCES movies.movie (id) ON UPDATE CASCADE ON DELETE CASCADE,
    FOREIGN KEY (genre_id) REFERENCES movies.genre (id) ON UPDATE CASCADE ON DELETE CASCADE
);

DELETE from movies.genre;
DELETE from movies.movie;
DELETE from movies.movie_genre;
DELETE from movies.movie_person;
DELETE from movies.person;
